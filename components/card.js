    ...
    <>
      <section className={`card-card ${props.rootClassName} `}>
        ...
        <main className="card-content">
          ...
          <p className="card-description1">{props.Description1}</p>
        </main>
      </section>
      <style jsx>
        {`
...
Card.defaultProps = {
  Description: 'Choose from millions spaces across Vietnam',
  rootClassName: '',
  Icon: '/playground_assets/group%201316-200w.png',
  Description1: 'Find your best option for every car journey',
  IconAlt: 'image',
  Header: 'Wherever, whenever',
}
